...
function EditProfile() {
  ...
  return (
    <div className='w-full h-[100vh] fixed top-0  z-[100] flex justify-center items-center'>
      ...
      <div className='w-[90%] max-w-[500px] h-[600px] bg-white relative overflow-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] z-[200] shadow-lg rounded-lg p-[10px]' >
        <div className='absolute top-[10px] right-[10px] cursor-pointer  ' onClick={() => setEdit(false)}><RxCross1 className='w-[25px] cursor-pointer h-[25px] text-gray-800 font-bold ' /></div>


        <div className='w-full h-[150px] bg-gray-500 rounded-lg mt-[30px] overflow-hidden' onClick={() => coverImage.current.click()}>
