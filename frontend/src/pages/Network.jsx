...
const socket = io("https://linkedin-backend-h0ha.onrender.com")
function Network() {
    ...
    return (
        <div className='w-screen h-[100vh] bg-[#F4F2EE] pt-[100px] px-[10px]  lg:px-[20px] flex flex-col items-center gap-[20px]'>
            <Nav />
            <div className='w-full lg:w-[90%] h-[100px] bg-[white] border-[1px] border-gray-300 rounded-lg flex items-center p-[10px] text-[22px] text-gray-600'>
                Invitations {connections.length}
            </div>

            {connections.length > 0 && <div className='w-[100%] max-w-[800px]  bg-white border-[1px] border-gray-300 rounded-lg flex flex-col gap-[20px] min-h-[100px]'>
